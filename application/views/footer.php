				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="<?php echo base_url()?>Public/img/i1.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i2.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i3.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i4.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i5.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i6.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i7.jpg" alt=""></li>
							<li><img src="<?php echo base_url()?>Public/img/i8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
